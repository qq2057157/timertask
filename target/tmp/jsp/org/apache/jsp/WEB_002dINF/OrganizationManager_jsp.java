...
public final class OrganizationManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/../views/OrganizationView.jsp");
    _jspx_dependants.add("/WEB-INF/../views/AddOrganizationView.jsp");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";  
      ...
      out.write("         location.href = '/timer/org/main?currentPage='+page;\n");
      ...
      out.write("\t\t\t<tr><td>组织名称</td><td class=\"td-nowrap\">组织代码</td><td class=\"td-nowrap\">创建时间</td><td class=\"td-nowrap\">管理员账号</td><td class=\"td-nowrap\">管理员姓名</td><td class=\"td-nowrap\">联系方式</td><td class=\"td-nowrap\">组织状态</td>\n");
      out.write("\t\t\t<td>操作\n");
      out.write("\t\t\t<a id=\"publishTask\" class=\"btn btn-default btn-sm\" data-toggle=\"modal\" data-target=\"#addOrgModal\" role=\"button\">\n");
      out.write("\t\t\t<span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\" ></span>新增组织</a></td></tr>\n");
      out.write("\t\t\t");
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("\t<!-- 添加组织弹出框start -->\n");
      out.write("\t<div class=\"modal fade\" id=\"addOrgModal\" tabindex=\"-1\" role=\"dialog\"\n");
      ...
      out.write("\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t<h4 class=\"modal-title\" id=\"myModalLabel\">新增组织</h4>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"organization\" placeholder=\"organization\" maxlength=\"20\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"col-xs-5 control-label text-right\">组织代码</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-4\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control inputArea\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"organizationCode\" placeholder=\"organizationCode\" maxlength=\"10\" onpaste=\"return false;\" \n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"text-center\" style=\"color:red;\">*</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span id=\"organizationCodeWarn\" class=\"text-center\" style=\"color:red;display:none\"><small>组织代码必须为纯数字</small></span>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<button id=\"addOrgButton\" type=\"button\" class=\"btn btn-primary\">确定</button>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      ...
      out.write("\t\n");
      out.write("\t$(\".org\").addClass(\"active\");\n");
      out.write("\t\n");
      out.write("\t$(document).on(\"click\",\"#registerSubmit\",function(){\n");
      out.write("\t\t//alert(\"jinlailai\");\n");
      ...
      out.write("\t\t} else {\n");
      out.write("\t\t\t$.ajax({\n");
      out.write("\t    \t\turl:\"/timer/org/addAdmin\",\n");
      out.write("\t    \t\tdata:{\n");
      ...
      out.write("\t    \t\t\t\talertModalMessage(\"添加管理员成功\");\n");
      out.write("\t    \t\t\t\t$(\".closeMessage\").addClass(\"refresh-btn\");\n");
      out.write("\t    \t\t\t} else if(data.code == 505) {\n");
      out.write("\t    \t\t\t\talertModalMessage(\"服务器发生异常，添加管理员失败\");\n");
      out.write("\t    \t\t\t} else {\n");
      out.write("\t    \t\t\t\talertModalMessage(\"添加管理员失败\");\n");
      out.write("\t    \t\t\t}\n");
      out.write("\t    \t\t}\n");
      out.write("\t    \t\t});\n");
      out.write("\t\t\t// ajax end;\n");
      ...
      out.write("    });\n");
      out.write("\t\n");
      out.write("\t$(document).on(\"click\",\".setAdmin\",function(){\n");
      out.write("\t\t//alert($(this).parents('td').prev().find('input.status').val());\n");
      out.write("\t\tvar mythis = $(this);\n");
      out.write("\t\tvar orgId = mythis.parents('td').find('input.id').val();\n");
      out.write("\t\tvar orgName = mythis.parents('tr').find(\".orgName\").find(\"small\").html();\n");
      out.write("\t\t//alert(orgName);\n");
      out.write("\t\tvar orgCode = mythis.parents('tr').find(\".orgCode\").find(\"small\").html();\n");
      out.write("\t\t//var status= mythis.parents('td').prev().find('input.status').val();\n");
      out.write("\t\t\n");
      out.write("\t\t$(\"#registerModal\").modal();\n");
      out.write("\t\t$(\"#myModalLabel.userRegTitle\").html(\"添加管理员\");\n");
      ...
      out.write("\t});\n");
      out.write("\t\n");
      out.write("\t$(document).on(\"click\",\".disableOrg\",function(){\n");
      out.write("\t\t//alert($(this).parents('td').prev().find('input.status').val());\n");
      out.write("\t\tvar mythis = $(this);\n");
      out.write("\t\t//alert($(this).parents('td').find('input.id').val());\n");
      out.write("\t\t$.ajax({\n");
      out.write("    \t\turl:\"/timer/org/disable\",\n");
      out.write("    \t\tdata:{\n");
      ...
      out.write("    \t\t\t\tmythis.addClass(\"enableOrg\");\n");
      out.write("    \t\t\t\tmythis.removeClass(\"disableOrg\");\n");
      ...
      out.write("\t});\n");
      out.write("\n");
      out.write("\t$(document).on(\"click\",\".enableOrg\",function(){\n");
      out.write("\t\t//alert($(this).parents('td').prev().find('input.status').val());\n");
      out.write("\t\tvar mythis = $(this);\n");
      out.write("\t\t//alert($(this).parents('td').find('input.id').val());\n");
      out.write("\t\t$.ajax({\n");
      out.write("    \t\turl:\"/timer/org/enable\",\n");
      out.write("    \t\tdata:{\n");
      out.write("    \t\t\tid:$(this).parents('td').find('input.id').val()\n");
      out.write("    \t\t},\n");
      out.write("    \t\ttype:'get',\n");
      ...
      out.write("    \t\t\t\tmythis.addClass(\"disableOrg\");\n");
      out.write("    \t\t\t\tmythis.removeClass(\"enableOrg\");\n");
      out.write("    \t\t\t} else if(data.code==505){\n");
      ...
      out.write("\t});\n");
      out.write("\t\n");
      out.write("\t$(document).on(\"click\",\".deleteOrg\",function(){\n");
      out.write("\t\t//alert($(this).parents('td').prev().find('input.status').val());\n");
      out.write("\t\tvar mythis = $(this);\n");
      out.write("\t\t//alert($(this).parents('td').find('input.id').val());\n");
      out.write("\t\t$.ajax({\n");
      out.write("    \t\turl:\"/timer/org/delete\",\n");
      out.write("    \t\tdata:{\n");
      out.write("    \t\t\tid:$(this).parents('td').find('input.id').val(),\n");
      out.write("    \t\t\torganizationCode:$(this).parents('tr').find('td.orgCode').find(\"small\").html()\n");
      out.write("    \t\t},\n");
      out.write("    \t\ttype:'get',\n");
      out.write("    \t\tdataType:'json',\n");
      out.write("    \t\tsuccess:function(data){\n");
      ...
      out.write("\t\t//ajax end;\n");
      out.write("\t});\n");
      out.write("\t$(\"#addOrgButton\").click(function(){\n");
      out.write("\t\tvar mythis = $(this);\n");
      out.write("\t\t$.ajax({\n");
      out.write("    \t\turl:\"/timer/org/add\",\n");
      out.write("    \t\tdata:{\n");
      ...
      out.write("    \t\t});\n");
      out.write("\t});\n");
      out.write("\t$(\"#organizationCode\").change(function(){\n");
      out.write("\t\tvar reg = new RegExp(\"^[0-9]*$\"); \n");
      out.write("\t\tif(!reg.test($(this).val())){\n");
      out.write("\t\t\tshow(\"#organizationCodeWarn\");\n");
      out.write("\t\t}else {\n");
      out.write("\t\t\thide(\"#organizationCodeWarn\");\n");
      out.write("\t\t}\n");
      out.write("\t});\n");
      out.write("});\n");
      out.write("</script>\n");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${orgModels}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t<small>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.organization}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</small>\n");
          out.write("\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t<td class=\"orgCode\">\n");
          out.write("\t\t\t\t\t\t<small>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.organizationCode}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</small>\n");
          out.write("\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t<small>\n");
          ...
          out.write("\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t<small>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.adminUsername}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</small>\n");
          out.write("\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t<small>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.adminName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</small>\n");
          out.write("\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t<small>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.adminPhone}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</small>\n");
          out.write("\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t<input class = \"status\" type=\"hidden\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.status}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
          out.write("\t\t\t\t\t\t<small>\n");
          out.write("\t\t\t\t\t\t\t");
          ...
          out.write("\">\n");
          out.write("\t\t\t\t\t\t<input class=\"adminId\" type=\"hidden\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.administratorId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
          out.write("\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_fmt_formatDate_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_fmt_formatDate_0.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.createTime}", java.util.Date.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_when_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.status==4}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_when_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.status==0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_when_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_3, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.organizationCode !=sessionScope.organizationCode}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_4 = _jspx_th_c_when_4.doStartTag();
    if (_jspx_eval_c_when_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t");
        if (_jspx_meth_c_choose_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_when_4, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
          return true;
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-danger btn-xs deleteOrg\" href=\"javascript:void(0);\">删除</button>\n");
        out.write("\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_choose_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:choose
    ...
    if (_jspx_eval_c_choose_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
        if (_jspx_meth_c_when_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_choose_4, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
          return true;
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
        ...
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
        if (_jspx_meth_c_otherwise_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_choose_4, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
          return true;
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_when_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:when
    ...
    _jspx_th_c_when_5.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.status==0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_5 = _jspx_th_c_when_5.doStartTag();
    if (_jspx_eval_c_when_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-xs setAdmin\" href=\"javascript:void(0);\">添加管理员</button>\n");
        out.write("\t\t\t\t\t\t\t      \t");
  ...
  private boolean _jspx_meth_c_when_6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_6.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${org.status==4}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_6 = _jspx_th_c_when_6.doStartTag();
    if (_jspx_eval_c_when_6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-xs enableOrg\" href=\"javascript:void(0);\">解禁</button>\n");
        out.write("\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_otherwise_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:otherwise
    ...
    if (_jspx_eval_c_otherwise_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-xs disableOrg\" href=\"javascript:void(0);\">封禁</button>\n");
        out.write("\t\t\t\t\t\t\t\t\t");
